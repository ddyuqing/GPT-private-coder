...
HUMAN_EVAL = "/Users/yuchientsai/Documents/code_gen/PyCodeGPT/apicoder/private-eval/data/TorchData_no.API_number_0.CodeGen.hm_False.machine.t0.1.p0.9.l100.n1.samples.jsonl"
# ------------------------------------------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    for i,sample in tqdm.tqdm(enumerate(stream_jsonl("/Users/yuchientsai/Documents/code_gen/PyCodeGPT/apicoder/private-eval/data/real_beatnum_eval_v3_api_1.jsonl.gz"))):
        pprint(i)